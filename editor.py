...
class Editor:
	def __init__(self, land_tiles, switch):
		...
		# clouds
		self.current_clouds = []
		self.cloud_surf = import_folder(
			'pirate maker/PirateMaker-main/graphics/clouds')
		...
		# music
		self.editor_music = pygame.mixer.Sound(
			'pirate maker/PirateMaker-main/audio/Explorer.ogg')
	...
	def imports(self):
		...
		self.sky_handle_surf = load(
			'pirate maker/PirateMaker-main/graphics/cursors/handle.png').convert_alpha()
